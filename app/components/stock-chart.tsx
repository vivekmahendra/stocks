...
import { Form, useSubmit, useNavigation, Link } from 'react-router';
...
export function StockChart({ 
  ...
  const isSubmitting = navigation.formAction === "/" && navigation.formData?.get("action") === "delete-ticker";
  ...
  if (!stockData.bars || stockData.bars.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow-md p-3">
        <h3 className="text-base font-semibold text-gray-800 mb-2">{stockData.symbol}</h3>
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow" ref={containerRef}>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center space-x-2">
                <CompanyLogo symbol={stockData.symbol} logoUrl={logoUrl} size="sm" />
          ...
          <div className="mt-2 pt-2 border-t border-gray-200">
            <div className="flex justify-between items-center text-xs text-gray-600">
              ...
              <div className="text-right">
                ...
                <div className={`font-medium px-1.5 py-0.5 rounded bg-gray-100 text-xs ${changeSinceAdded >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4 shadow-xl">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900">Remove Ticker</h3>
                <p className="text-sm text-gray-500">This action cannot be undone</p>
              </div>
            </div>
            <p className="text-gray-600 mb-6">
              Are you sure you want to remove <strong>{stockData.symbol}</strong> from your watchlist?
            </p>
